...
config :shadowfallscampground, Shadowfallscampground.Repo,
  database: Path.expand("../shadowfallscampground_dev.db", Path.dirname(__ENV__.file)),
  pool_size: 5,
...
config :shadowfallscampground, ShadowfallscampgroundWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "BJxpO1ghysBiZf9n3Rmaxi90WtE++zczCAQeLElpmwAQCfmJ4op2uuGuByuVwLZz",
  watchers: [
...
config :shadowfallscampground, ShadowfallscampgroundWeb.Endpoint,
  ...
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/shadowfallscampground_web/(live|views|components|pages|sections|svg)/.*(ex|sface|js)$",
