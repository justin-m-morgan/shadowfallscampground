defmodule Mix.Tasks.Gen.Surface.Section do
  @moduledoc """
  A script for generating composite component files and their accompanying files (test, surface catalogue, etc)
  """
  @shortdoc "Generate Surface Component"

  @base_path "lib/shadowfallscampground_web/sections"
  @module_path "ShadowfallscampgroundWeb.Sections"
