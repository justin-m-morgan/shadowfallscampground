defmodule Mix.Tasks.Gen.Surface.Page do
  @moduledoc """
  A script for generating "page" components files and their accompanying files (test, surface catalogue, etc)
  """
  @shortdoc "Generate Surface Page"

  @base_path "lib/shadowfallscampground_web/pages"
  @module_path "ShadowfallscampgroundWeb.Pages"
