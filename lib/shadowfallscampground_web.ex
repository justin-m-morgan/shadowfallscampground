defmodule ShadowfallscampgroundWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ShadowfallscampgroundWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/shadowfallscampground_web/templates",
        namespace: ShadowfallscampgroundWeb
  ...
  defp view_helpers do
    quote do
      ...
      import ShadowfallscampgroundWeb.LiveHelpers
